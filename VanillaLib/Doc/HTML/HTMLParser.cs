		...
		public void  HTMLDocument()
		{
			...
			while (true)
			{
				switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
				{
                    ...
                    case VanillaLib.HTMLParserConstants_Fields.ScriptStart:
                    case VanillaLib.HTMLParserConstants_Fields.TagName:
                    case VanillaLib.HTMLParserConstants_Fields.DeclName:
                    case VanillaLib.HTMLParserConstants_Fields.Comment1:
                    case VanillaLib.HTMLParserConstants_Fields.Comment2:
                    case VanillaLib.HTMLParserConstants_Fields.Word:
                    case VanillaLib.HTMLParserConstants_Fields.Entity:
                    case VanillaLib.HTMLParserConstants_Fields.Space:
                    case VanillaLib.HTMLParserConstants_Fields.Punct: 
						;
						break;
				...
				switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
				{
                    ...
                    case VanillaLib.HTMLParserConstants_Fields.Word:
                        t = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.Word);
						AddText(t.image); afterTag = false;
						break;

                    case VanillaLib.HTMLParserConstants_Fields.Entity:
                        t = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.Entity);
						AddText(Entities.Decode(t.image)); afterTag = false;
						break;

                    case VanillaLib.HTMLParserConstants_Fields.Punct:
                        t = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.Punct);
						AddText(t.image); afterTag = false;
						break;

                    case VanillaLib.HTMLParserConstants_Fields.Space:
                        Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.Space);
...
label_1_brk: ;
		...
		public void  Tag()
		{
			Token t1, t2;
			bool inImg = false;
            t1 = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.TagName);
			...
			while (true)
			{
				switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
				{
                    ...
                    case VanillaLib.HTMLParserConstants_Fields.ArgName: 
						;
						break;
                ...
                t1 = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ArgName);
				switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
				{

                    case VanillaLib.HTMLParserConstants_Fields.ArgEquals:
                        Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ArgEquals);
						switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
						{

                            case VanillaLib.HTMLParserConstants_Fields.ArgValue:
                            case VanillaLib.HTMLParserConstants_Fields.ArgQuote1:
                            case VanillaLib.HTMLParserConstants_Fields.ArgQuote2: 
								t2 = ArgValue();
...
Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.TagEnd);
		}
		...
		public Token ArgValue()
		{
			...
			switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
			{
                ...
                case VanillaLib.HTMLParserConstants_Fields.ArgValue:
                    t = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ArgValue);
					{
						if (true)
							return t;
					}
				...
				default: 
					...
					if (Jj_2_1(2))
					{
                        Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ArgQuote1);
                        Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.CloseQuote1);
						{
							if (true)
								return t;
						}
					...
					else
					{
						switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
						{
                            ...
                            case VanillaLib.HTMLParserConstants_Fields.ArgQuote1:
                                Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ArgQuote1);
                                t = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.Quote1Text);
                                Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.CloseQuote1);
								{
									if (true)
										return t;
							...
							default: 
								...
								if (Jj_2_2(2))
								{
                                    Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ArgQuote2);
                                    Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.CloseQuote2);
									{
										if (true)
											return t;
									}
								...
								else
								{
									switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
									{
                                        ...
                                        case VanillaLib.HTMLParserConstants_Fields.ArgQuote2:
                                            Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ArgQuote2);
                                            t = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.Quote2Text);
                                            Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.CloseQuote2);
											{
												if (true)
													return t;
		...
		{
			Token t;
            t = Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.DeclName);
			while (true)
			{
				switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
				{
				...
				switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
				{
                    ...
                    case VanillaLib.HTMLParserConstants_Fields.ArgName:
                        Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ArgName);
						break;
...
label_3_brk: ;
		...
		public void  CommentTag()
		{
			switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
			{
                ...
                case VanillaLib.HTMLParserConstants_Fields.Comment1:
                    Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.Comment1);
					while (true)
					{
						switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
						{

                            case VanillaLib.HTMLParserConstants_Fields.CommentText1: 
								;
								break;
                        ...
                        Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.CommentText1);
					}

label_4_brk: ;

                    Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.CommentEnd1);
					break;

                case VanillaLib.HTMLParserConstants_Fields.Comment2:
                    Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.Comment2);
					while (true)
					{
						switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
						{

                            case VanillaLib.HTMLParserConstants_Fields.CommentText2: 
								;
								break;
                        ...
                        Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.CommentText2);
					}

label_5_brk: ;

                    Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.CommentEnd2);
					break;
		...
		{
            Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ScriptStart);
			while (true)
			{
				switch ((jj_ntk == - 1) ? Jj_ntk() : jj_ntk)
				{

                    case VanillaLib.HTMLParserConstants_Fields.ScriptText: 
						;
						break;
                ...
                Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ScriptText);
			}

label_6_brk: ;
			
			Jj_consume_token(VanillaLib.HTMLParserConstants_Fields.ScriptEnd);
		}
		...
		private bool Jj_3_1()
		{
            if (Jj_scan_token(VanillaLib.HTMLParserConstants_Fields.ArgQuote1))
				return true;
            if (Jj_scan_token(VanillaLib.HTMLParserConstants_Fields.CloseQuote1))
				return true;
			return false;
		}
		...
		private bool Jj_3_2()
		{
            if (Jj_scan_token(VanillaLib.HTMLParserConstants_Fields.ArgQuote2))
				return true;
            if (Jj_scan_token(VanillaLib.HTMLParserConstants_Fields.CloseQuote2))
				return true;
			return false;
		}
		...
		public virtual ParseException GenerateParseException()
		{
            ...
            return new ParseException(token, exptokseq, VanillaLib.HTMLParserConstants_Fields.tokenImage);
		}
