        ...
        */
        ...
        {    // obtainSearcher calls ensureOpen
            ...
            try
            {
                ...
                correspondScore = new float[sugQueue.Size()];

                for (int i = sugQueue.Size() - 1; i >= 0; i--)
                {
                    SuggestWord sugWrd = sugQueue.Pop() as SuggestWord;
                    list[i] = sugWrd.string_Renamed;
                    correspondScore[i] = sugWrd.score;
                }
        ...
        public float[] CorrespondScore
        {
            get
            {
                return correspondScore;
            }
        }
